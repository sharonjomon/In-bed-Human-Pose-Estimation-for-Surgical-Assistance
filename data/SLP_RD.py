...
def getImg_dsPM(dsFd='/scratch/jmnsha002/SLP2022/SLP/danaLab', idx_subj=1, modality='IR', cov='uncover',
                idx_frm=1):
	'''
...
def genPTr_dict(subj_li, mod_li, dsFd='/scratch/jmnsha002/SLP2022/SLP/danaLab'):
	'''
...
class SLP_RD:  # slp reader
	...
	def __init__(self, opts, phase='train', if_0base=True):
		...
		# righ upper leg,
		# right lower leg
		self.phys_arr = phys_arr.astype(float)  # all list
